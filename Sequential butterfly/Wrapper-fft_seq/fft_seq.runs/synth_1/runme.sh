...
HD_PWD='C:/Users/macie/Desktop/SDUP/Sekwencyjny_1_motyl/fft_seq/fft_seq.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log fft_seq_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source fft_seq_wrapper.tcl
