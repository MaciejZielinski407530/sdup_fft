...
HD_PWD='C:/Users/macie/Desktop/SDUP/Sekwencyjny_1_motyl/fft_seq/fft_seq.runs/fft_seq_xbar_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log fft_seq_xbar_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source fft_seq_xbar_0.tcl
