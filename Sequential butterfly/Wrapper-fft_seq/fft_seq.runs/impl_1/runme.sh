...
HD_PWD='C:/Users/macie/Desktop/SDUP/Sekwencyjny_1_motyl/fft_seq/fft_seq.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log fft_seq_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source fft_seq_wrapper.tcl -notrace
