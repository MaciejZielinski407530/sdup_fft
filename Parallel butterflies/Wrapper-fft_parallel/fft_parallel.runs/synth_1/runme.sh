...
HD_PWD='C:/Users/macie/Desktop/SDUP/fft_parallel/fft_parallel.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log fft_parallel_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source fft_parallel_wrapper.tcl
