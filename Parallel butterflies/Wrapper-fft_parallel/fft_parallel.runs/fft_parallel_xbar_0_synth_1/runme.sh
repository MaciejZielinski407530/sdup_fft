...
HD_PWD='C:/Users/macie/Desktop/SDUP/fft_parallel/fft_parallel.runs/fft_parallel_xbar_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log fft_parallel_xbar_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source fft_parallel_xbar_0.tcl
