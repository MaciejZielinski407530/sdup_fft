...
HD_PWD='C:/Users/macie/Desktop/SDUP/fft_parallel/fft_parallel.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log fft_parallel_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source fft_parallel_wrapper.tcl -notrace
