...
HD_PWD='C:/Users/macie/Desktop/SDUP/Projekt_fft_pipeline_N/Projekt_fft_pipeline_N.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log fft_p.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source fft_p.tcl
